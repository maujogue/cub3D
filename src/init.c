...
/*   Updated: 2023/06/27 16:13:52 by maujogue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_cub(t_all *all, char *map)
{
	...
	all->ray.texture[0].img = mlx_xpm_file_to_image(all->mlx, \
			"./assets/xpm/floor.xpm", &(all->ray.texture[0].pix_height), &(all->ray.texture[0].pix_height));
	...
	all->ray.texture[1].img = mlx_xpm_file_to_image(all->mlx, \
			"./assets/xpm/floor.xpm", &(all->ray.texture[1].pix_height), &(all->ray.texture[1].pix_height));
	...
	all->ray.texture[2].img = mlx_xpm_file_to_image(all->mlx, \
			"./assets/xpm/floor.xpm", &(all->ray.texture[2].pix_height), &(all->ray.texture[2].pix_height));
